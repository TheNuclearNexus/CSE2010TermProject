...
/**
 * <p>
 * <b>You may add additional methods, but may not change existing methods</b>
 * </p>
 *
 ...
 * <li>path: the location on the board for each consecutive letter of the word
 * (ArrayList of Location)</li>
 * </ol>
 *
 * <p>
 * <i>Note that for words that contain "QU", the length of a word is longer
 * than its path by 1 since "QU" in a word is represented by "Q" on the
 * board</i>
 * </p>
 *
 * <p>
 * The constructors allocate an ArrayList of Locations for the path
 * </p>
 *
 *
 * @author Philip Chan
...
public class Word {
     ...
     * Location objects on the path are not allocated since actual path length is
     * not known.
     *
