...
public class EvalBogglePlayer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (processingTimeInSec > 300) {
            System.err
                    .println("Preprocessing time \"" + processingTimeInSec + " sec\" is too long--more than 5 minutes");
            System.exit(-1);
        }
        ...
        // DecimalFormat df = new DecimalFormat("0.####E0"); // moved to near
        // initialization
    ...
    /**
     * Checks if the word is valid and assigns positive points for valid word and
     * negative points for invalid word
     *
    ...
    private static int checkForWordValidity(Word word, char[][] board) {
        ...
        // Check each letter on the board is used at most once and if letter are are the
        // board or not
     ...
     * adapted from
     * 
     * https://stackoverflow.com/questions/34624892/how-to-measure-peak-heap-memory-
     * usage-in-java
     * 
     * https://docs.oracle.com/javase/8/docs/api/java/lang/management/MemoryType.
     * html
    ...
    private static long peakMemoryUsage() {
        ...
        for (MemoryPoolMXBean memoryPoolMXBean : pools) {
            if (memoryPoolMXBean.getType() == MemoryType.HEAP) {
                ...
                // System.out.println("Peak used for: " + memoryPoolMXBean.getName() + " is: " +
                // peakUsage);
